...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 05 mars 2020 à 15:18
...
(9, 'lj,mplù', 'kj hjoikoplml', '2020-03-05 11:12:42', 'draft', 1, 2, NULL);
...
(3, 'Gel\'ial', 'LALA SKA', '2020-02-25 11:36:29', 'Un roman glaçant !', 1, 'posted'),
...
CREATE TABLE IF NOT EXISTS `contact` (
  ...
  `status_mail_contact` varchar(128) NOT NULL DEFAULT 'read',
  PRIMARY KEY (`id`)
...
(8, 'Nat', 'trucmuche@yo.com', 'Super', 'Bravo encore !', '2020-02-29 16:32:08', 'unread'),
