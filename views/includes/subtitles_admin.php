<!--ADMIN SUBTITLES-->
<div class="admin_subtitles">
    <img class="main_picture" id="admin_main_picture" src="https://media.giphy.com/media/iFU36VwXUd2O43gdcr/source.gif" alt="gif homme qui tape à la machine à écrire" />
